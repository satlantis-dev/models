...
type CommunityMembershipApplication struct {
	...
	Type                CommunityMembershipApplicationType   `gorm:"type:varchar(32);not null;default:'new';index;uniqueIndex:idx_community_membership_pending_unique,where:status = 'pending' AND deleted_at IS NULL" json:"type"`
