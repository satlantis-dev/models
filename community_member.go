...
type CommunityMember struct {
	...
	ActiveSubscriptionID *uint                            `gorm:"index" json:"activeSubscriptionId,omitempty"`
	ActiveSubscription   *CommunityMembershipSubscription `gorm:"foreignKey:ActiveSubscriptionID;constraint:OnDelete:SET NULL;" json:"activeSubscription,omitempty"`
