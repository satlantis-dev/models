...
type CalendarEvent struct {
	...
	RsvpLimit               *int64                      `json:"rsvpLimit,omitempty"`
	RsvpWaitlistEnabledAt   *time.Time                  `json:"rsvpWaitlistEnabledAt,omitempty"`
	RsvpGatedEnabledAt      *time.Time                  `json:"rsvpGatedEnabledAt,omitempty"`
