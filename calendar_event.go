...
type CalendarEvent struct {
	...
	IsExternallyManaged              bool                          `gorm:"default:false" json:"isExternallyManaged"`
	...
	LocationClarification            *string                       `json:"locationClarification,omitempty"`
...
func (c CalendarEvent) ToDTO() *CalendarEventDTO {
	...
	return &CalendarEventDTO{
		...
		IsOnline:            c.IsOnline,
		IsExternallyManaged: c.IsExternallyManaged,
		Location:            c.Location,
		PlaceID:             c.PlaceID,
		Place:               c.Place,
		Start:               c.Start,
