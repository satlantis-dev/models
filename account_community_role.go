...
type CommunityRoleType string

const (
	CommunityRoleAdmin CommunityRoleType = "admin"
)
...
type AccountCommunityRole struct {
	...
	Role                 CommunityRoleType `gorm:"type:varchar(32);not null;uniqueIndex:idx_account_community_role" json:"role"`
